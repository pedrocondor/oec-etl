...
class RussiaSubnationalMetaRegionPipeline(RussiaSubnationalPipeline):
    @staticmethod
    def run(params, **kwargs):
        ...
        load_step = LoadStep(
            "rus_meta_region", db_connector, if_exists="append", dtype=DTYPE, pk=['id', 'name']
        )
...
if __name__ == '__main__':
    pipeline = RussiaSubnationalMetaRegionPipeline()
    pipeline.run({
